cfg = {}
cfg['input_dim'] = 0 # input dimension to LSTM
cfg['hidden_dim'] = 0# hidden dimension for LSTM
cfg['output_dim'] = 0# output dimension of the model
cfg['layers'] = 0# number of layers of LSTM
cfg['dropout'] = 0# dropout rate between two layers of LSTM; useful only when layers > 1; between 0 and 1
cfg['bidirectional'] = 0# True or False; True means using a bidirectional LSTM
cfg['batch_size'] = 0# batch size of input
cfg['learning_rate'] = 0# learning rate to be used
cfg['L2_penalty'] = 0# weighting constant for L2 regularization term; this is a parameter when you define optimizer
cfg['gen_temp'] = 0# temperature to use while generating reviews
cfg['max_len'] = 0# maximum character length of the generated reviews
cfg['epochs'] = 0# number of epochs for which the model is trained
